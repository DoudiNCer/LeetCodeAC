...
*/
func main() {
	fmt.Println("browserHistory := Constructor(\"leetcode.com\")")
	browserHistory := Constructor("leetcode.com")
	fmt.Println("browserHistory.Visit(\"google.com\")")
	browserHistory.Visit("google.com")
	fmt.Println("browserHistory.Visit(\"facebook.com\")")
	browserHistory.Visit("facebook.com")
	fmt.Println("browserHistory.Visit(\"youtube.com\")")
	...
	fmt.Println("browserHistory.Visit(\"linkedin.com\")")
...
func (this *BrowserHistory) Visit(url string) {
	this.bs = append(this.bs[:this.p+1], url)
	this.p++
}
...
func (this *BrowserHistory) Back(steps int) string {
	...
	return this.bs[this.p]

}

func (this *BrowserHistory) Forward(steps int) string {
	this.p += steps
	if this.p >= len(this.bs) {
		this.p = len(this.bs) - 1
	}
	return this.bs[this.p]
}
