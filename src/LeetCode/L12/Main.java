...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("s.intToRoman(3) = " + s.intToRoman(3));
        System.out.println("s.intToRoman(58) = " + s.intToRoman(58));
        System.out.println("s.intToRoman(1994) = " + s.intToRoman(1994));
    }
}
