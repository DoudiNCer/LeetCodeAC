...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("s.largestPerimeter(new int[]{5, 5, 5}) = " + s.largestPerimeter(new int[]{5, 5, 5}));
        System.out.println("s.largestPerimeter(new int[]{1, 12, 1, 2, 5, 50, 3}) = " + s.largestPerimeter(new int[]{1, 12, 1, 2, 5, 50, 3}));
    }
}
