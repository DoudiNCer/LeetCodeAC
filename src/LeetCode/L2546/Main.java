...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("s.makeStringsEqual(\"1010\", \"0110\") = " + s.makeStringsEqual("1010", "0110"));
        System.out.println("s.makeStringsEqual(\"11\", \"00\") = " + s.makeStringsEqual("11", "00"));
    }
}
